...
class TGOMMODatabaseHandler:
    ...
    def insert_environment_creature_records(self):
        environment_creature_data = [
            ...
            self.format_creature_environment_link_params(BLACK_WIDOW_DEX_NO, 1, EASTERN_US_FOREST_NO,  2, NIGHT, TGOMMO_RARITY_UNCOMMON, '', SUB_ENVIRONMENT_GARDEN),
            ...
            self.format_creature_environment_link_params(BAT_DEX_NO, 1, EASTERN_US_FOREST_NO,  2, NIGHT, TGOMMO_RARITY_UNCOMMON, '', SUB_ENVIRONMENT_FIELD),
