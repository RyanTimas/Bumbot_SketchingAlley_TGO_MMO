...
class TGOMMODatabaseHandler:
    ...
    def get_environment_creatures_for_current_environment_by_dex_no(self, dex_no=0, convert_to_object=True):
        query = f"{TGOMMO_SELECT_ENVIRONMENT_CREATURE_BASE} {TGOMMO_SELECT_ENVIRONMENT_CREATURE_BY_ENVIRONMENT_DEX_NO_SUFFIX};"
        return self.get_environment_creatures_from_database(query=query, params=(dex_no,), convert_to_object=convert_to_object, expect_multiple=False)
    ...
    def insert_creature_records(self):
        creature_data = [
            ...
            ('Python', '', 164, 1, 'Burmese Python', 'Python bivittatus', REPTILE, '', BURMESE_PYTHON_IMAGE_ROOT, 5, TGOMMO_RARITY_RARE),
    ...
    def insert_environment_creature_records(self):
        eastern_us_environment_creature_data = [
            ...
            EnvironmentCreatureLink(MOUNTAIN_LION_DEX_NO, 1, EASTERN_US_NO,          NIGHT, TGOMMO_RARITY_LEGENDARY, '', SUB_ENVIRONMENT_FOREST),
            # WAVE 3
        ...
        everglades_environment_creature_data = [
            # WAVE 1
            EnvironmentCreatureLink(ALLIGATOR_DEX_NO,                                   1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER, FL_ALLIGATOR_IMAGE_ROOT),
            EnvironmentCreatureLink(MOUNTAIN_LION_DEX_NO,                                   1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, 'Panther', SUB_ENVIRONMENT_RIVER, PANTHER_IMAGE_ROOT, 67, 67,),

            EnvironmentCreatureLink(GREEN_ANOLE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(CURLY_TAILED_LIZARD_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(EASTERN_GLASS_LIZARD_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GOPHER_TORTOISE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(FLORIDA_SOFTSHELL_TURTLE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(NORTH_AMERICAN_RACER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(EASTERN_CORALSNAKE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(SQUIRREL_TREEFROG_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GREATER_SIREN_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(NORTHERN_MOCKINGBIRD_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(PALM_WARBLER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(YELLOW_RUMPED_WARBLER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(COMMON_GRACKLE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),

            EnvironmentCreatureLink(PAINTED_BUNTING_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(PAINTED_BUNTING_DEX_NO,                             2, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),

            EnvironmentCreatureLink(WHITE_CROWNED_PIGEON_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(BLACK_VULTURE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(RED_SHOULDERED_HAWK_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(OSPREY_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(BARRED_OWL_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(CRESTED_CARACARA_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(SWALLOW_TAILED_KITE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(BLACK_BELLIED_WHISTLING_DUCK_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(PURPLE_GALLINULE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(LITTLE_BLUE_HERON_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(YELLOW_CROWNED_NIGHT_HERON_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GREAT_EGRET_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(REDDISH_EGRET_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(WHITE_IBIS_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(ANHINGA_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(WOOD_STORK_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(SPOONBILL_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(MOSQUITO_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GULF_FRITILLARY_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GULF_FRITILLARY_DEX_NO,                             2, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(ZEBRA_LONGWING_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(ATALA_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(EASTERN_PONDHAWK_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(LUBBER_GRASSHOPPER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GOLDEN_ORB_WEAVER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(SPINYBACKED_ORB_WEAVER_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(BUMBLEBEE_MILLIPEDE_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(FLORIDA_TREE_SNAIL_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(NINE_BANDED_ARMADILLO_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(FOX_SQUIRREL_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(MINK_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(GRAY_FOX_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(ROYAL_TERN_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(LAUGHING_GULL_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(BROWN_PELICAN_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(AMERICAN_WHITE_PELICAN_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(MAGNIFICENT_FRIGATEBIRD_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(MAGNIFICENT_FRIGATEBIRD_DEX_NO,                             2, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
            EnvironmentCreatureLink(ATLANTIC_GHOST_CRAB_DEX_NO,                             1, FLORIDA_NO,        BOTH, TGOMMO_RARITY_COMMON, '', SUB_ENVIRONMENT_RIVER),
        ]
        ...
        for ec_link in environment_creature_data:
            creature_info = self.get_creature_by_dex_and_variant_no(ec_link.creature_dex_no, ec_link.creature_variant_no)
            environment_info = self.get_environments_by_dex_no(dex_no=ec_link.environment_dex_no)
    ...
    def format_creature_environment_link_params(self, creature_dex_no, creature_variant_no, environment_dex_no, environment_variant_no, spawn_time, rarity, local_name='', sub_environment=SUB_ENVIRONMENT_FOREST, local_image_root='', local_dex_no=0, local_variant_no=0):
        ...
        environment_info = self.get_environment_by_dex_no_and_variant_no(dex_no=environment_dex_no, variant_no=environment_variant_no)

        return (
            creature_info.creature_id,                                                                                   # creature_id
            environment_info.environment_id,                                                                            # environment_id
            spawn_time,                                                                                         # spawn_time
            environment_info.dex_no,                                                                            # environment_dex_no
            environment_info.variant_no,                                                                            # environment_variant_no
            creature_info.creature_name,                                                              # creature_name
            environment_info.name,                                                                      # environment_name
            rarity,                                                                                                   # spawn_rarity
            local_name,                                                                                          # local_name
            sub_environment,                                                                                # sub_environment_type
            local_dex_no if local_dex_no != 0 else creature_dex_no,                      # local_dex_no
            local_variant_no if local_variant_no != 0 else creature_variant_no,       # local_variant_no
