...
TGOMMO_SELECT_USER_CREATURE_BY_ENVIRONMENT_ID_DEX_NO_SUFFIX = "uc.environment_id IN (SELECT DISTINCT environment_id FROM tgommo_environment_creature WHERE environment_dex_no = ?)"
