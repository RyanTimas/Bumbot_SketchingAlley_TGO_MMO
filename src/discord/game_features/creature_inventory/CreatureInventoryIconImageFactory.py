...
class CreatureInventoryIconImageFactory:
    ...
    def add_text_to_image(self, image: Image):
        ...
        pixel_location = get_centered_text_position(text= self.creature.nickname, font=nickname_font, center_pixel_location=(40, 80))
        ...
        pixel_location = get_centered_text_position(text= self.creature.name, font=species_font, center_pixel_location=(40, 96))
        ...
        pixel_location = get_centered_text_position(text=f'{self.creature.catch_id}', font=catch_id_font, center_pixel_location=(40, 110))
