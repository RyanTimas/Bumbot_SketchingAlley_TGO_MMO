...
RARITY_CHARM_IDS = [
    ITEM_ID_COMMON_CHARM,
    ITEM_ID_UNCOMMON_CHARM,
    ITEM_ID_RARE_CHARM,
    ITEM_ID_EPIC_CHARM,
    ITEM_ID_LEGENDARY_CHARM,
    ITEM_ID_TRANSCENDANT_CHARM,
    ITEM_ID_OMNIPOTENT_CHARM,

    ITEM_ID_COMMON_ULTRA_CHARM,
    ITEM_ID_UNCOMMON_ULTRA_CHARM,
    ITEM_ID_RARE_ULTRA_CHARM,
    ITEM_ID_EPIC_ULTRA_CHARM,
    ITEM_ID_LEGENDARY_ULTRA_CHARM,
    ITEM_ID_TRANSCENDANT_ULTRA_CHARM,
    ITEM_ID_OMNIPOTENT_ULTRA_CHARM
]
KINGDOM_CHARM_IDS = [
    ITEM_ID_MAMMAL_CHARM,
    ITEM_ID_BIRD_CHARM,
    ITEM_ID_REPTILE_CHARM,
    ITEM_ID_AMPHIBIAN_CHARM,
    ITEM_ID_BUG_CHARM,

    ITEM_ID_MAMMAL_ULTRA_CHARM,
    ITEM_ID_BIRD_ULTRA_CHARM,
    ITEM_ID_REPTILE_ULTRA_CHARM,
    ITEM_ID_AMPHIBIAN_ULTRA_CHARM,
    ITEM_ID_BUG_ULTRA_CHARM
]
# endregion
