...
BUG_EXTENDED = f"{BUG}, {INSECT}, {MOLLUSK}, {CRUSTACEAN}, {ARACHNID}, {CLITELLATA}, {MYRIAPOD}, {ARTHROPOD}, {ASTEROIDEA}"
...
""" ----- TRAP MANAGER  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"""
TRAP_MANAGER_OPEN_TAB_SUMMARY = "Summary"
TRAP_MANAGER_OPEN_TAB_CAPTURES = "Captures"
...
ITEM_CATEGORY_KEY_ITEM = "Key Item"
ITEM_CATEGORY_INVISIBLE = "Invisible"
ITEM_CATEGORY_USE = "Use"
ITEM_CATEGORY_CREATURE = "Creature"
# endregion
...
ITEM_ID_PLANE_TICKET_WA  = f"{ITEM_TYPE_PLANE_TICKET}_4"
ITEM_ID_PLANE_TICKET_AZ  = f"{ITEM_TYPE_PLANE_TICKET}_4"
ITEM_ID_PLANE_TICKET_HI  = f"{ITEM_TYPE_PLANE_TICKET}_4"

item_id_plane_ticket_map = {
    ITEM_ID_PLANE_TICKET_EST: EASTERN_US_DEX_NO,
    ITEM_ID_PLANE_TICKET_FL: FLORIDA_DEX_NO,
    ITEM_ID_PLANE_TICKET_IC: ICELAND_DEX_NO,
    ITEM_ID_PLANE_TICKET_WY: YELLOWSTONE_DEX_NO
}
...
# endregion
# region Bait Groupings
rarity_bait_ids = [
    ITEM_ID_COMMON_BAIT,
    ITEM_ID_UNCOMMON_BAIT,
    ITEM_ID_RARE_BAIT,
    ITEM_ID_EPIC_BAIT,
    ITEM_ID_LEGENDARY_BAIT,
    ITEM_ID_MYTHICAL_BAIT,
    ITEM_ID_TRANSCENDANT_BAIT,
    ITEM_ID_OMNIPOTENT_BAIT
]
kingdom_bait_ids = [
    ITEM_ID_MAMMAL_BAIT,
    ITEM_ID_BIRD_BAIT,
    ITEM_ID_REPTILE_BAIT,
    ITEM_ID_AMPHIBIAN_BAIT,
    ITEM_ID_BUG_BAIT
]

rarity_bait_map = {
    ITEM_ID_COMMON_BAIT: TGOMMO_RARITY_COMMON,
    ITEM_ID_UNCOMMON_BAIT: TGOMMO_RARITY_UNCOMMON,
    ITEM_ID_RARE_BAIT: TGOMMO_RARITY_RARE,
    ITEM_ID_EPIC_BAIT: TGOMMO_RARITY_EPIC,
    ITEM_ID_LEGENDARY_BAIT: TGOMMO_RARITY_LEGENDARY,
    ITEM_ID_MYTHICAL_BAIT: TGOMMO_RARITY_MYTHICAL,
    ITEM_ID_TRANSCENDANT_BAIT: TGOMMO_RARITY_TRANSCENDANT,
    ITEM_ID_OMNIPOTENT_BAIT: TGOMMO_RARITY_OMNIPOTENT
}
...
# region Charm Groupings
CHARM_IDS = [
    ITEM_ID_CHARM,
    ITEM_ID_ULTRA_CHARM,
]
MYTHICAL_CHARM_IDS = [
    ITEM_ID_MYTHICAL_CHARM,
    ITEM_ID_MYTHICAL_ULTRA_CHARM
]
RARITY_CHARM_MAP = {
    ITEM_ID_COMMON_CHARM: TGOMMO_RARITY_COMMON,
    ITEM_ID_UNCOMMON_CHARM: TGOMMO_RARITY_UNCOMMON,
    ITEM_ID_RARE_CHARM: TGOMMO_RARITY_RARE,
    ITEM_ID_EPIC_CHARM: TGOMMO_RARITY_EPIC,
    ITEM_ID_LEGENDARY_CHARM: TGOMMO_RARITY_LEGENDARY,
    ITEM_ID_TRANSCENDANT_CHARM: TGOMMO_RARITY_TRANSCENDANT,
    ITEM_ID_OMNIPOTENT_CHARM: TGOMMO_RARITY_OMNIPOTENT,

    ITEM_ID_COMMON_ULTRA_CHARM: TGOMMO_RARITY_COMMON,
    ITEM_ID_UNCOMMON_ULTRA_CHARM: TGOMMO_RARITY_UNCOMMON,
    ITEM_ID_RARE_ULTRA_CHARM: TGOMMO_RARITY_RARE,
    ITEM_ID_EPIC_ULTRA_CHARM: TGOMMO_RARITY_EPIC,
    ITEM_ID_LEGENDARY_ULTRA_CHARM: TGOMMO_RARITY_LEGENDARY,
    ITEM_ID_TRANSCENDANT_ULTRA_CHARM: TGOMMO_RARITY_TRANSCENDANT,
    ITEM_ID_OMNIPOTENT_ULTRA_CHARM: TGOMMO_RARITY_OMNIPOTENT,
}
KINGDOM_CHARM_MAP = {
    ITEM_ID_MAMMAL_CHARM: MAMMAL,
    ITEM_ID_BIRD_CHARM: BIRD,
    ITEM_ID_REPTILE_CHARM: REPTILE,
    ITEM_ID_AMPHIBIAN_CHARM: AMPHIBIAN,
    ITEM_ID_BUG_CHARM: BUG_EXTENDED,

    ITEM_ID_MAMMAL_ULTRA_CHARM: MAMMAL,
    ITEM_ID_BIRD_ULTRA_CHARM: BIRD,
    ITEM_ID_REPTILE_ULTRA_CHARM: REPTILE,
    ITEM_ID_AMPHIBIAN_ULTRA_CHARM: AMPHIBIAN,
    ITEM_ID_BUG_ULTRA_CHARM: BUG_EXTENDED,
}
# endregion
