...
AVATAR_GEX_QUEST_QUERY = """SELECT COUNT(DISTINCT(c.creature_id)) >= 3 FROM tgommo_user_creature uc LEFT JOIN tgommo_creature c ON uc.creature_id = c.creature_id WHERE c.kingdom = "Bird"  AND uc.user_id = ?;"""
